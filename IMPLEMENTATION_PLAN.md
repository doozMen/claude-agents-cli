...
- `AZURE_DEVOPS_ORG_URL`: Organization URL (e.g., `https://dev.azure.com/rossel`)
- `AZURE_DEVOPS_PAT`: Personal Access Token
- `AZURE_DEVOPS_DEFAULT_PROJECT`: Default project name (optional)

**Available 1Password References**:
- `op://Employee/Rossel Azure - Gitlab/gitlab private access token api` (likely shared GitLab/Azure token)
...
**Available 1Password References**:
- `op://Employee/Rossel/gitlab mcp full access sauf ai and kubernetes`
- `op://Employee/Rossel Azure - Gitlab/gitlab private access token api`
- `op://Employee/Rossel Azure - Gitlab/private key` (SSH key for git operations)
...
public enum KnownSecret: String, Sendable, CaseIterable {
  ...
  public var onePasswordReference: String? {
    ...
    case .azureDevOpsPat:
      return "op://Employee/Rossel Azure - Gitlab/gitlab private access token api"
    case .azureDevOpsDefaultProject:
      return nil  // Manual input required
    case .gitlabPersonalAccessToken:
      return "op://Employee/Rossel/gitlab mcp full access sauf ai and kubernetes"
    case .gitlabApiUrl:
...
private func setupWithKeychain(service: SecretsService) async throws {
  ...
  if configureAzure {
    ...
    var orgUrl = ""
    while true {
      print("Azure DevOps Organization URL (e.g., https://dev.azure.com/rossel): ", terminator: "")
...
1. **SSH Key Management**:
   ...
   - Reference: `op://Employee/Rossel Azure - Gitlab/private key`
