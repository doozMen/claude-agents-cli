...
- **Alamofire** → **URLSession + async/await** (Sudinfo: 90 files, VDN: 5 apps)
...
### Alamofire → URLSession + async/await (Sudinfo/VDN)
```swift
...
**Effort**: 80 hours (90 files in Sudinfo), 16 hours per VDN app
