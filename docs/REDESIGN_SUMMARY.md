...
The current secrets management implementation hardcodes Rossel-specific 1Password URIs like `op://Employee/Rossel/gitlab mcp...` directly in the code. This makes the tool organization-specific and not reusable by other teams or individuals.

**Issues:**
1. Hardcoded 1Password references in `Secret.swift`
2. Organization-specific naming (Rossel, Employee vault)
